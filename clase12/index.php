      ...
      <div class="card-header card text-white bg-primary">
        ...
        <div class="card-body">
          <form class="" action="procesar.php" method="post">
            <input type="text" name="nombre" value="" class="form-control"> <br>
            <input type="text" name="telefono" value="" class="form-control"> <br>
            <input type="text" name="correo" value="" class="form-control"> <br>
            <textarea name="sugerencias" rows="8" cols="80" class="form-control"></textarea>
            <br>
